...
type event = BaseSyntheticEvent | SyntheticEvent;
...
const AuthPage = (props: any) => {
  ...
  const onLogin = (e: event) => {
    ...
    axios
      ...
      .catch((e: any) => console.log(JSON.stringify(e.response.data)));
  };
      ...
      <div className="card">
        ...
        <form onSubmit={onLogin}>
          ...
          <input
            ...
            onChange={(e: event) => setSecret(e.target.value)}
          />
        ...
        <form onSubmit={onSignup}>
          ...
          <input
            ...
            onChange={(e: event) => setFirstName(e.target.value)}
          />
          <input
            type="text"
            name="last_name"
            placeholder="Last name"
            onChange={(e: event) => setLastName(e.target.value)}
          />
